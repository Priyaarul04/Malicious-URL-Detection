...
st.markdown("<h1 style='text-align: center; color: #14559E'>Malicious URL Detection</h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; color: #494848;'>Using AI Model</h3>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #494848;'></p>", unsafe_allow_html=True)
